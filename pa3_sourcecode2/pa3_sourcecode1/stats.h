...
private:
	vector< vector< long long> > sumRed;
	vector< vector< long long> > sumGreen;
	vector< vector< long long> > sumBlue;
	vector< vector< long long> > sumsqRed;
	vector< vector< long long> > sumsqGreen;
	vector< vector< long long> > sumsqBlue;
	...
	* @param lr is (x,y) of the lower right corner of the rectangle */
	long long getSum(char channel, pair<int,int> ul, pair<int,int> lr);
	...
	* @param ul is (x,y) of the upper left corner of the rectangle
	* @param lr is (x,y) of the lower right corner of the rectangle */
	long long getSumSq(char channel, pair<int,int> ul, pair<int,int> lr);
...
public:
	...
	/* @param ul is (x,y) of the upper left corner of the rectangle
	* @param lr is (x,y) of the lower right corner of the rectangle */
	long long getScore(pair<int,int> ul, pair<int,int> lr);
	...
	* @param lr is (x,y) of the lower right corner of the rectangle */
	...
	/* @param ul is (x,y) of the upper left corner of the rectangle
	* @param lr is (x,y) of the lower right corner of the rectangle */
	long long rectArea(pair<int,int> ul, pair<int,int> lr);
